...
public class TextFieldsPanel extends JPanel {
    public TextFieldsPanel() {
        ...
        gbc.gridy = 4;
        GUI_Task_06.textField = new JTextArea( 10, 40);
        GUI_Task_06.textField.setLineWrap(true);
        GUI_Task_06.textField.setBorder(border);

        JScrollPane scrollPane = new JScrollPane(GUI_Task_06.textField);
