...
public class TextFieldsPanel extends JPanel {
    public TextFieldsPanel() {
        ...
        gbc.gridy = 4;
        GUI_Task_05.textField = new JTextArea( 10, 40);
        GUI_Task_05.textField.setLineWrap(true);
        GUI_Task_05.textField.setBorder(border);

        JScrollPane scrollPane = new JScrollPane(GUI_Task_05.textField);
